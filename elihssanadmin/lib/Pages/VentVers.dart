import 'package:elihssanadmin/Components/Affichage/VentVersAffichage.dart';
import 'package:elihssanadmin/Components/ButtomNav/VerVersNav.dart';
import 'package:elihssanadmin/Components/Widgets/AllBonsOfClient.dart';
                                ...
                                children: [
                                  Expanded(
                                      child: Container(
                                          alignment: Alignment.center,
                                          child: Text(
                                            "${clientsProv.AllAboutClient[index].client.IdUser}",
