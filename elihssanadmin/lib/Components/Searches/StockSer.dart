          ...
          child: Row(children: [
            Expanded(
              ...
              children: [
                IconButton(
                    onPressed: () async {
                      await Provider.of<ProduitsProv>(context, listen: false)
            ...
            Expanded(
              child: Text(
                  ...
                  "${Product.dateAchat.substring(0, 10)}"),
            ),
            Expanded(
                child:
                    Text(textAlign: TextAlign.center, "${Product.PrixAchat}")),
            Expanded(
                child: Text(textAlign: TextAlign.center, "${Product.cntt}")),
            Expanded(
                child: Text(
                    textAlign: TextAlign.center, "${Product.ZoneStockage}")),
            Expanded(
            ...
            Expanded(
                child: Text(
                    textAlign: TextAlign.center, "${Product.Fournisseur}")),
          ]),
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          Expanded(child: Text(textAlign: TextAlign.center, "${Product.name}")),
          Expanded(
            child: Text(
                textAlign: TextAlign.center,
                "${Product.dateAchat.substring(0, 10)}"),
          ...
          Expanded(
              child: Text(textAlign: TextAlign.center, "${Product.PrixAchat}")),
          Expanded(child: Text(textAlign: TextAlign.center, "${Product.cntt}")),
          Expanded(
              child:
                  Text(textAlign: TextAlign.center, "${Product.ZoneStockage}")),
          Expanded(
            child: dateTime.year != 0
                ? cmp == -1
                    ? Text(
          ...
          Expanded(
              child:
                  Text(textAlign: TextAlign.center, "${Product.Fournisseur}")),
        ]),
      ),
    );
  }
