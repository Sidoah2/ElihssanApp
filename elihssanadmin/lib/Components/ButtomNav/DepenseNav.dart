import 'package:elihssanadmin/Components/Widgets/Empl.dart';
                                          ...
                                          children: [
                                            pw.Expanded(
                                              child: pw.Text(
                                                  textAlign:
                                                      pw.TextAlign.center,
                                                  "${depensesProv.AllDepenses[index].User}"),
                                            ),
                                          ],
                                        )),
                                        pw.Expanded(
                    ...
                    content: Wrap(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              EmplSelected = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EmployeesSelecte(),
                                  ));
                            },
                            child: Container(
