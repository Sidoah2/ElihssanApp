...
import 'package:elihssanadmin/Components/ButtomNav/BottomNav.dart';
...
class _ButtomCatalogueState extends State<ButtomArticle> {
  ...
  show_image_piker(obs, nameproduit) async {
    ...
    await Provider.of<ArticlePropoProv>(context, listen: false)
        .AddArticles(obs, nameproduit, base64str, context, "admin");
