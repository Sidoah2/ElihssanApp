...
class ClientsServ {
  static Future<List<ClientObj>> getAllclients(IdUser) async {
  ...
  static Future<List<AllAboutClientObjet>> getAllAboutclients(IdUser) async {
    List<AllAboutClientObjet> allAboutClients = [];
    List<ClientObj> AllClients = await getAllclients(IdUser);
